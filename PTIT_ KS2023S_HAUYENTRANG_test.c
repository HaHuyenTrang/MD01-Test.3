...
void nameSort(contact temp[], int index){
    ...
    do{
        ...
        switch(choice){
            ...
            case 3:
                ...
                gets(updateName);
                for (i=0;i<index;i++){
                    if ( strcmp(contactList[i].name,updateName) == 0 ){
                        input(&contactList[i]);
                        check = 1;
                    }
                }
...
//                while( start<=end ) {
//                    mid = (start+end) / 2;
//                    if ( strcmp(contactList[mid].name,findName) == 0 ){
//                        break;
//                    } else if (contactList[mid].name < findName) {
//                        start = mid+1;
//                    } else {
//                        end = mid-1;
//                    }
